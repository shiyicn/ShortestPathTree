...
\begin{algorithm}[H]
 \KwData{An directed graph $G = (V, E)$, non negative wights, a source node $v\in V$, travel time $t$, $\omega : E \rightarrow \mathbb{R}$, $d : V \rightarrow \mathbb{R}$ distance to v, $settled : V \rightarrow boolean$ and $p: V \rightarrow V$, predecessor of a vertex $x\in V$}
